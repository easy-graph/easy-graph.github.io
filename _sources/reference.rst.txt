...
For now, Easy Graph has implemented graph computation functions, 
...
are implemented with Python language in Easy Graph, even if the original authors 
of some graph computing methods are using different language, C and C++, for instance. 

With the help of Easy Graph, users can easily try and compare different graph computation 
