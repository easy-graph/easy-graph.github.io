...
package management system, `pip <https://pip.pypa.io/en/stable>`_, for installation.
You can find EasyGraph on PyPI at this `link <https://pypi.org/project/Python-EasyGraph/>`_.
